...
namespace SevenStrikeModules.XTween
{
    ...
    {
        /// <summary>
        /// 创建一个从当前低通滤波器截止频率到目标低通滤波器截止频率的动画
        /// </summary>
        /// <param name="lp">目标 AudioLowPassFilter 组件</param>
        /// <param name="endValue">目标低通滤波器截止频率</param>
        /// <param name="duration">动画持续时间，单位为秒</param>
        /// <param name="autokill">动画完成后是否自动销毁</param>
        /// <returns>创建的动画对象</returns>
        public static XTween_Interface xt_AudioLowPassFilter_CutoffFrequency_To(this AudioLowPassFilter lp, float endValue, float duration, bool autokill = false, bool rewind_set_startvalue = true, bool complete_set_endvalue = true)
        {
            if (lp == null)
            {
                Debug.LogError("AudioLowPassFilter component is null!");
                return null;
            }

            float start = lp.cutoffFrequency;
        ...
        /// <returns>创建的动画对象</returns>
        public static XTween_Interface xt_AudioLowPassFilter_CutoffFrequency_To(this AudioLowPassFilter lp, float endValue, float duration, bool autokill, EaseMode easeMode, bool isFromMode, XTween_Getter<float> fromvalue, bool useCurve, AnimationCurve curve)
        {
            if (lp == null)
            {
                Debug.LogError("AudioLowPassFilter component is null!");
