...
namespace SevenStrikeModules.XTween
{
    ...
    public partial class XTween_Controller
    {
        ...
        private void TweenPlay_Rotation()
        {
            ...
            {
                CurrentTweener = XTween.xt_Rotate_To(Target_RectTransform, EndValue_Vector3, Duration, IsRelative, IsAutoKill, RotationSpace, RotationMode, EaseMode, IsFromMode, () => FromValue_Vector3, UseCurve, Curve).SetLoop(LoopCount, LoopType).SetLoopingDelay(LoopDelay).SetDelay(Delay).OnStart(() =>
                {
            ...
            {
                CurrentTweener = XTween.xt_Rotate_To(Target_RectTransform, EndValue_Quaternion, Duration, IsRelative, IsAutoKill, RotationSpace, RotateLerpMode, EaseMode, IsFromMode, () => FromValue_Quaternion, UseCurve, Curve).SetLoop(LoopCount, LoopType).SetLoopingDelay(LoopDelay).SetDelay(Delay).OnStart(() =>
                {
                    if (act_on_start != null)
                        act_on_start();
                }).OnStop(() =>
