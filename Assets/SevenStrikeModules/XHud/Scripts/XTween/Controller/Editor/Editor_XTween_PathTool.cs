namespace SevenStrikeModules.XTween
{
    ...
    public class Editor_XTween_PathTool : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            #region 图标获取
            icon_main = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/icon_main");
            icon_worldmode = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/icon_worldmode");
            icon_pathpercent = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/icon_pathpercent");
            icon_add_r = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/icon_add_r");
            icon_add_p = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/icon_add_p");
            clear_r = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/clear_r");
            clear_p = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/clear_p");
            repos_zero_r = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/repos_zero_r");
            repos_zero_p = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/repos_zero_p");
            createpathmarks_r = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/createpathmarks_r");
            createpathmarks_p = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/createpathmarks_p");
            locate = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/locate");
            status = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/status");
            icon_startpos = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/icon_startpos");
            icon_pathlength = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/icon_pathlength");
            icon_Grandparent = util_XHUDGUI.GetIcon("Icons_Hud_XTween_PathTool/icon_Grandparent");
            #endregion
            ...
            IndexStyle.font = AssetDatabase.LoadAssetAtPath<Font>(XTween_Dashboard.Get_XHudRoot_Path() + "Fonts/Text/SevenStrikeFont_Bold.ttf");
            GetAllTargets();
            ...
            PathPoints = new ReorderableList(serializedObject, sp_PathPoints)
            {
                ...
                drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
                {
                    ...
                    if (sp_root != null)
                    {
                        util_XHUDGUI.Gui_Labelfield(new Rect(rect.x + 25, titleheight - 3.5f, (rect.width * 0.45f) - 20, LineHeight), $"#  路径点 {index.ToString()}", HudFilled.无, HudColor.亮白, Color.white, TextAnchor.MiddleLeft, Vector2.zero, 12, TextClipping.Clip);

                        GUI.color = XTween_Dashboard.Theme_Primary;
                        util_XHUDGUI.Gui_Icon(new Rect(rect.x + 5, titleheight, 10, 10), locate);
                        ...
                        #region 最小音高
                        util_XHUDGUI.Gui_Labelfield_Thin(new Rect(rect.x + 5, titleheight + 20, rect.width - 15, 19), $"<color={hexcol}> -   Relative   :   </color>" + util_Tools.Vector3_To_String(sp_relative.vector3Value), HudFilled.无, HudColor.无, Color.gray, TextAnchor.MiddleLeft, Vector2.zero, 11, false, false, true);
                        util_XHUDGUI.Gui_Labelfield_Thin(new Rect(rect.x + 5, titleheight + 40, rect.width - 15, 19), $"<color=#c2c2c2> -   World   :   </color>" + util_Tools.Vector3_To_String(sp_world.vector3Value), HudFilled.无, HudColor.无, Color.gray, TextAnchor.MiddleLeft, Vector2.zero, 11, false, false, true);
                        util_XHUDGUI.Gui_Labelfield_Thin(new Rect(rect.x + 5, titleheight + 60, rect.width - 15, 19), $"<color={hexcol}> -   Anchored   :   </color>" + util_Tools.Vector3_To_String(sp_anchored.vector3Value), HudFilled.无, HudColor.无, Color.gray, TextAnchor.MiddleLeft, Vector2.zero, 11, false, false, true);
                        util_XHUDGUI.Gui_Labelfield_Thin(new Rect(rect.x + 5, titleheight + 80, rect.width - 15, 19), $"<color=#c2c2c2> -   Bezier_In   :   </color>" + util_Tools.Vector3_To_String(sp_bezier_in.vector3Value), HudFilled.无, HudColor.无, Color.gray, TextAnchor.MiddleLeft, Vector2.zero, 11, false, false, true);
                        util_XHUDGUI.Gui_Labelfield_Thin(new Rect(rect.x + 5, titleheight + 100, rect.width - 15, 19), $"<color={hexcol}> -   Bezier_Out   :   </color>" + util_Tools.Vector3_To_String(sp_bezier_out.vector3Value), HudFilled.无, HudColor.无, Color.gray, TextAnchor.MiddleLeft, Vector2.zero, 11, false, false, true);
                        util_XHUDGUI.Gui_Labelfield_Thin(new Rect(rect.x + 5, titleheight + 120, rect.width - 15, 19), $"<color=#c2c2c2> -   BezierWorld_In   :   </color>" + util_Tools.Vector3_To_String(sp_bezier_in_world.vector3Value), HudFilled.无, HudColor.无, Color.gray, TextAnchor.MiddleLeft, Vector2.zero, 11, false, false, true);
                        util_XHUDGUI.Gui_Labelfield_Thin(new Rect(rect.x + 5, titleheight + 140, rect.width - 15, 19), $"<color={hexcol}> -   BezierWorld_Out   :   </color>" + util_Tools.Vector3_To_String(sp_bezier_out_world.vector3Value), HudFilled.无, HudColor.无, Color.gray, TextAnchor.MiddleLeft, Vector2.zero, 11, false, false, true);
                        #endregion
                    }
                },
        ...
        public override void OnInspectorGUI()
        {
            ...
            util_XHUDGUI.Gui_Layout_Banner(icon_main, HudFilled.实体, HudColor.深空灰, "HudTween - 路径工具", Color.white, 20, 20);

            #region 快捷功能
            util_XHUDGUI.Gui_Layout_Vertical_Start(HudFilled.纯色边框, HudColor.亮白, 5, "快捷功能", XTween_Dashboard.Theme_Primary);
            ...
            #region 添加路径点
            GUI.enabled = true;
            if (util_XHUDGUI.Gui_Layout_Button(15, "添加路径点", icon_add_r, icon_add_p))
            {
                PathPoints_Add();
                return;
            }
            ...
            #region 清空路径点
            GUI.enabled = true;
            if (util_XHUDGUI.Gui_Layout_Button(15, "清空路径点", clear_r, clear_p))
            {
                PathPoints_Clear();
                return;
            }
            ...
            #region 路径点深度归零
            GUI.enabled = true;
            if (util_XHUDGUI.Gui_Layout_Button(15, "路径点深度归零", repos_zero_r, repos_zero_p))
            {
            ...
            #region 生成路径标记
            GUI.enabled = true;
            if (util_XHUDGUI.Gui_Layout_Button(15, "生成路径标记", createpathmarks_r, createpathmarks_p))
            {
                PathMarksCreator();
                return;
            }
            ...
            #region 路径列表
            util_XHUDGUI.Gui_Layout_Vertical_Start(HudFilled.纯色边框, HudColor.亮白, 5, "路径列表", XTween_Dashboard.Theme_Primary);
            ...
            #region 有效路径百分比
            util_XHUDGUI.Gui_Layout_Vertical_Start(HudFilled.纯色边框, HudColor.亮白, 5, "有效路径百分比", XTween_Dashboard.Theme_Primary);
            util_XHUDGUI.Gui_Layout_Space(10);
            ...
            util_XHUDGUI.Gui_Labelfield_Thin(new Rect(rect_longpress.x + 5, rect_longpress.y + 8, 50, 6), "起点", HudFilled.无, HudColor.无, XTween_Dashboard.Theme_Primary, TextAnchor.MiddleLeft, new Vector2(0, 0), 9);

            util_XHUDGUI.Gui_Labelfield_Thin(new Rect(rect_longpress.x + (EditorGUIUtility.currentViewWidth - 110), rect_longpress.y + 8, 50, 6), "终点", HudFilled.无, HudColor.无, Color.gray, TextAnchor.MiddleRight, new Vector2(0, 0), 9);
            ...
            util_XHUDGUI.Gui_Icon(new Rect(((rect_longpress.x + 1) + (EditorGUIUtility.currentViewWidth - 65) * sp_PathLimitePercent.floatValue), rect_longpress.y + 6, 8, 8), icon_pathpercent);
            ...
            util_XHUDGUI.Gui_Layout_Space(28);
            util_XHUDGUI.Gui_Layout_Vertical_End();
            #endregion
            ...
            util_XHUDGUI.Gui_Layout_Popup<string, XTween_PathTool>("路径样式", actionlist, ref sp_IndexPathType, HudFilled.实体, 120, 22, SelectedObjects, (comps) => { }, (res) =>
            {
            ...
            util_XHUDGUI.Gui_Layout_Popup<string, XTween_PathTool>("朝向模式", actionlist, ref sp_IndexPathOrientation, HudFilled.实体, 120, 22, SelectedObjects, (comps) => { }, (res) =>
            {
            ...
            if (BaseScript.PathOrientation != XTween_PathOrientation.无)
            {
                ...
                util_XHUDGUI.Gui_Layout_Popup<string, XTween_PathTool>("朝向轴向", actionlist, ref sp_IndexPathOrientationVector, HudFilled.实体, 120, 22, SelectedObjects, (comps) => { }, (res) =>
                {
            ...
            util_XHUDGUI.Gui_Layout_Popup<string, XTween_PathTool>("控制点样式", actionlist, ref sp_IndexControlLineStyle, HudFilled.实体, 120, 22, SelectedObjects, (comps) => { }, (res) =>
            {
            ...
            util_XHUDGUI.Gui_Layout_Popup<string, XTween_PathTool>("生成标记方式", actionlist, ref sp_IndexPathMarkMode, HudFilled.实体, 120, 22, SelectedObjects, (comps) => { }, (res) =>
            {
            ...
            #region 路径闭合
            util_XHUDGUI.Gui_Layout_Toggle<bool, XTween_PathTool>("路径闭合", new string[] { "禁用", "启用" }, ref sp_IsClosed, HudFilled.无, HudFilled.实体, Color.white, 120, 22, SelectedObjects);
            #endregion

            #region 显示路径
            util_XHUDGUI.Gui_Layout_Toggle<bool, XTween_PathTool>("显示路径", new string[] { "禁用", "启用" }, ref sp_DisplayPath, HudFilled.无, HudFilled.实体, Color.white, 120, 22, SelectedObjects);
            #endregion

            #region 显示路径点信息
            util_XHUDGUI.Gui_Layout_Toggle<bool, XTween_PathTool>("显示路径点信息", new string[] { "禁用", "启用" }, ref sp_DisplayIndex, HudFilled.无, HudFilled.实体, Color.white, 120, 22, SelectedObjects);
            #endregion

            #region 注视线
            util_XHUDGUI.Gui_Layout_Toggle<bool, XTween_PathTool>("注视线可视化", new string[] { "禁用", "启用" }, ref sp_LookAtLine, HudFilled.无, HudFilled.实体, Color.white, 120, 22, SelectedObjects);
            #endregion
            util_XHUDGUI.Gui_Layout_Space(10);
            util_XHUDGUI.Gui_Layout_Vertical_End();
            #endregion
            ...
            {
                util_XHUDGUI.Gui_Layout_Vertical_Start(HudFilled.纯色边框, HudColor.亮白, 5, "注视参数", XTween_Dashboard.Theme_Primary);
                util_XHUDGUI.Gui_Layout_Space(5);
                if (BaseScript.PathOrientation == XTween_PathOrientation.注视目标物体)
                {
                    util_XHUDGUI.Gui_Layout_Space(5);
                    util_XHUDGUI.Gui_Layout_Property_Field("目标物体", sp_LookAtObject);
                }
                if (BaseScript.PathOrientation == XTween_PathOrientation.注视目标位置)
                {
                    util_XHUDGUI.Gui_Layout_Space(5);
                    util_XHUDGUI.Gui_Layout_Property_Field("目标位置", sp_LookAtPosition);
                }
                util_XHUDGUI.Gui_Layout_Space(5);
                util_XHUDGUI.SetEnabled(false);
                util_XHUDGUI.Gui_Layout_Property_Field("连线坐标数组", sp_LookAtPoints);
            ...
            #region 开关状态
            util_XHUDGUI.Gui_Layout_Vertical_Start(HudFilled.纯色边框, HudColor.亮白, 5, "开关状态", XTween_Dashboard.Theme_Primary);
            util_XHUDGUI.Gui_Layout_Space(5);
            #region 世界状态     
            util_XHUDGUI.StatuDisplayer_text(icon_worldmode, 12, new Vector2(0, 7), "世界状态", 12, sp_IsWorldMode.boolValue ? "启用" : "禁用", sp_IsWorldMode.boolValue ? XTween_Dashboard.Theme_Primary : Color.gray, 11);
            #endregion

            #region 初始坐标     
            util_XHUDGUI.StatuDisplayer_text(icon_startpos, 12, new Vector2(0, 7), "初始坐标", 12, util_Tools.Vector3_To_String(sp_StartPosition.vector3Value), XTween_Dashboard.Theme_Primary, 11);
            #endregion

            #region 路径长度     
            util_XHUDGUI.StatuDisplayer_text(icon_pathlength, 12, new Vector2(0, 7), "路径长度", 12, sp_PathLength.floatValue.ToString("F2"), XTween_Dashboard.Theme_Primary, 11);
            #endregion

            #region 路径父级物体
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.StatuDisplayer_Object(icon_Grandparent, 12, new Vector2(0, 1), "路径父级物体", 12, new Vector2(0, -7), status, new Vector2(0, 3), sp_PathParent.objectReferenceValue == null ? false : true, XTween_Dashboard.Theme_Primary, Color.black * 0.7f, sp_PathParent);
            #endregion
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Vertical_End();
            #endregion
            ...
            #region 路径参数
            util_XHUDGUI.Gui_Layout_Vertical_Start(HudFilled.纯色边框, HudColor.亮白, 5, "路径参数", XTween_Dashboard.Theme_Primary);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("有效路径百分比", sp_PathLimitePercent, 120);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径步数细分", sp_SegmentsPerCurve, 120);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("添加路径初始距离", sp_AddedDistance, 120);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Vertical_End();
            #endregion

            #region 路径样式
            util_XHUDGUI.Gui_Layout_Vertical_Start(HudFilled.纯色边框, HudColor.亮白, 5, "路径样式", XTween_Dashboard.Theme_Primary);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径点尺寸", sp_PathPointSize, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("贝塞尔控制点尺寸", sp_BezierControlSize, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径宽度", sp_PathWidth, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径信息尺寸", sp_IndexSize, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径信息高度", sp_IndexLengthHeight, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径信息偏移", sp_IndexOffset, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("注视线宽度", sp_LookAtLineWidth, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径颜色", sp_Color_Path, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径点颜色", sp_Color_PathPoint, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径点选中颜色", sp_Color_PathPoint_Selected, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("控制点颜色", sp_Color_BezierControl, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("控制点选中颜色", sp_Color_BezierControl_Selected, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径点序号颜色", sp_Color_Index, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("路径点信息颜色", sp_Color_IndexLength, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("注视线颜色", sp_Color_LookAtLine, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("标记颜色", sp_PathMarksColor, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Vertical_End();
            #endregion

            #region 路径标记生成
            util_XHUDGUI.Gui_Layout_Vertical_Start(HudFilled.纯色边框, HudColor.亮白, 5, "路径标记生成", XTween_Dashboard.Theme_Primary);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("标记样式", sp_PathMarksTexture, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("标记尺寸", sp_PathMarksSize, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Property_Field("标记采样", sp_PathMarksSample, 110);
            util_XHUDGUI.Gui_Layout_Space(5);
            util_XHUDGUI.Gui_Layout_Vertical_End();
            #endregion
            ...
            if (e.type == EventType.MouseDown && e.button == 1)
            {
                ...
                if (sp_PathMarksGroup.objectReferenceValue == null)
                {
                    ...
                    {
                        string res = util_XHUDGUI.Open(XHudDialogType.警告, "HudTweenPath消息", "创建标记物", "此操作会根据当前的路径生成标记物！", "创建", "暂不", 1);
                        if (res == "创建")
                        {
                ...
                else
                {
                    ...
                    {
                        string res_de = util_XHUDGUI.Open(XHudDialogType.警告, "HudTweenPath消息", "已存在标记物", "此操作会将当前的所有路径标记物全部清除！", "清除", "暂不", 1);
                        if (res_de == "清除")
                        {
        ...
        {
            string res = util_XHUDGUI.Open(XHudDialogType.警告, "HudTweenPath消息", "清空路径点", "此操作将清空当前已设置的所有路径点！请谨慎操作！", "清空", "暂不", 1);
            if (res == "清空")
            {
        ...
        {
            string res = util_XHUDGUI.Open(XHudDialogType.警告, "HudTweenPath消息", "路径点Z轴归零", "此操作会将当前已设置的所有路径点的Z轴坐标归零到画布！请谨慎操作！", "归零", "暂不", 1);
            if (res == "归零")
            {
