namespace SevenStrikeModules.XTween
{
    ...
    public partial class XTween_Controller
    {
        ...
        /// 动画 - XHudTmpText方法
        /// </summary>
        private void TweenPlay_XHudTmpText()
        {
            ...
            {
                CurrentTweener = XTween.xt_FontSize_To(Target_HudTmpText, EndValue_Float, Duration, IsAutoKill, EaseMode, IsFromMode, () => FromValue_Float, UseCurve, Curve).SetLoop(LoopCount, LoopType).SetLoopingDelay(LoopDelay).SetDelay(Delay).OnStart(() =>
                {
            ...
            else if (TweenTypes_XHudTmpText == XTweenTypes_XHudTmpText.文字行高_LineHeight)
            {
                CurrentTweener = XTween.xt_FontLineHeight_To(Target_HudTmpText, EndValue_Float, Duration, IsAutoKill, EaseMode, IsFromMode, () => FromValue_Float, UseCurve, Curve).SetLoop(LoopCount, LoopType).SetLoopingDelay(LoopDelay).SetDelay(Delay).OnStart(() =>
                {
                    if (act_on_start != null)
                        act_on_start();
                }).OnStop(() =>
            ...
            else if (TweenTypes_XHudTmpText == XTweenTypes_XHudTmpText.文字颜色_Color)
            {
                CurrentTweener = XTween.xt_FontColor_To(Target_HudTmpText, EndValue_Color, Duration, IsAutoKill, EaseMode, IsFromMode, () => FromValue_Color, UseCurve, Curve).SetLoop(LoopCount, LoopType).SetLoopingDelay(LoopDelay).SetDelay(Delay).OnStart(() =>
                {
                    if (act_on_start != null)
                        act_on_start();
                }).OnStop(() =>
            ...
            else if (TweenTypes_XHudTmpText == XTweenTypes_XHudTmpText.文字内容_Content)
            {
                CurrentTweener = XTween.xt_FontText_To(Target_HudTmpText, IsExtendedString, EndValue_String, Duration, IsAutoKill, EaseMode, IsFromMode, () => FromValue_String, UseCurve, Curve).SetLoop(LoopCount, LoopType).SetLoopingDelay(LoopDelay).SetDelay(Delay).OnStart(() =>
                {
                    if (act_on_start != null)
                        act_on_start();
                }).OnStop(() =>
            ...
            else if (TweenTypes_XHudTmpText == XTweenTypes_XHudTmpText.文字间距_Character)
            {
                CurrentTweener = XTween.xt_FontCharacter_To(Target_HudTmpText, EndValue_Float, Duration, IsAutoKill, EaseMode, IsFromMode, () => FromValue_Float, UseCurve, Curve).SetLoop(LoopCount, LoopType).SetLoopingDelay(LoopDelay).SetDelay(Delay).OnStart(() =>
                {
                    if (act_on_start != null)
                        act_on_start();
                }).OnStop(() =>
            ...
            else if (TweenTypes_XHudTmpText == XTweenTypes_XHudTmpText.文字边距_Margin)
            {
                CurrentTweener = XTween.xt_FontMargin_To(Target_HudTmpText, EndValue_Vector4, Duration, IsAutoKill, EaseMode, IsFromMode, () => FromValue_Vector4, UseCurve, Curve).SetLoop(LoopCount, LoopType).SetLoopingDelay(LoopDelay).SetDelay(Delay).OnStart(() =>
                {
                    if (act_on_start != null)
                        act_on_start();
                }).OnStop(() =>
