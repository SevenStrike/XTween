namespace SevenStrikeModules.XTween
{
    ...
    public partial class XTween_Controller : MonoBehaviour
    {
        ...
        /// <summary>
        /// HudManager管理器动画子类型，当TweenTypes为XHudManager时生效
        /// 用于选择要修改的全局HUD属性，如遮罩参数、音量控制等
        /// </summary>
        [SerializeField] public XTweenTypes_XHudManager TweenTypes_XHudManager = XTweenTypes_XHudManager.屏幕空间元素透明度_ScreenElementsOpacity;
        /// <summary>
        /// HudAnimator动画器动画子类型，当TweenTypes为XHudAnimator时生效
        /// </summary>
        [SerializeField] public XTweenTypes_XHudAnimator TweenTypes_XHudAnimator = XTweenTypes_XHudAnimator.原始色_OriginalColor;
        /// <summary>
        /// HudElement元素动画子类型，当TweenTypes为XHudElement时生效
        /// </summary>
        [SerializeField] public XTweenTypes_XHudElement TweenTypes_XHudElement = XTweenTypes_XHudElement.透明度_Opacity;
        /// <summary>
        /// HudText文本动画子类型，当TweenTypes为XHudText时生效
        /// 用于选择文本组件要动画化的属性：字体/颜色_Color/间距等
        /// </summary>
        [SerializeField] public XTweenTypes_XHudText TweenTypes_XHudText = XTweenTypes_XHudText.文字尺寸_FontSize;
        /// <summary>
        /// HUD HudTmpText文本动画子类型，当TweenTypes为XHudTmpText时生效
        /// 用于选择TextMeshPro文本要动画化的属性，包含更多文本控制选项
        /// </summary>
        [SerializeField] public XTweenTypes_XHudTmpText TweenTypes_XHudTmpText = XTweenTypes_XHudTmpText.文字尺寸_FontSize;
        /// <summary>
...
#pragma warning disable CS0414
        ...
        /// <summary>
        /// 索引 - HudManager管理器动画子类型
        /// </summary>
        [SerializeField] public string index_TweenTypes_XHudManager = "屏幕空间元素透明度_ScreenElementsOpacity";
        /// <summary>
        /// 索引 - HudAnimator动画器动画子类型
        /// </summary>
        [SerializeField] public string index_TweenTypes_XHudAnimator = "原始色_OriginalColor";
        /// <summary>
        /// 索引 - HudText文本动画子类型
        /// </summary>
        [SerializeField] public string index_TweenTypes_XHudText = "文字尺寸_FontSize";
        /// <summary>
        /// 索引 - HudTmpText文本动画子类型
        /// </summary>
        [SerializeField] public string index_TweenTypes_XHudTmpText = "文字尺寸_FontSize";
        /// <summary>
        /// 索引 - HudElement动画子类型
        /// </summary>
        [SerializeField] public string index_TweenTypes_XHudElement = "透明度_Opacity";
        /// <summary>
        /// 索引 - To动画子类型
        /// </summary>
...
#pragma warning disable CS0414
        ...
        [SerializeField] private bool LiquidLEDBlink = true;
#pragma warning restore CS0414
        #endregion

        #region 组件节点
        [SerializeField] private UnityEngine.RectTransform Target_RectTransform;
        [SerializeField] private Image Target_Image;
        [SerializeField] private CanvasGroup Target_CanvasGroup;
        [SerializeField] private Text Target_HudText;
        [SerializeField] private TextMeshProUGUI Target_HudTmpText;
        ...
        private void RandomDelaySet()
        {
            ...
            if (DebugMode)
                util_Tools.Func_PrintInfo("XTween控制器消息", $"已随机化延迟时间： 最小: {RandomDelay.Min} 最大: {RandomDelay.Max} ！", HudMsgState.设置);
        }
        /// <summary>
        /// 获取组件
        /// </summary>
        public void GetComponents()
        {
            ...
            if (m_PathTool)
            {
                if (Target_PathTool == null)
                {
                    ...
                    if (DebugMode)
                        util_Tools.Func_PrintInfo("XTween控制器消息", $"已找到组件：{m_PathTool}  ！", HudMsgState.确认);
                }
            }
            ...
            if (m_RectTransform)
            {
                if (Target_RectTransform == null)
                {
                    ...
                    if (DebugMode)
                        util_Tools.Func_PrintInfo("XTween控制器消息", $"已找到组件：{m_RectTransform}  ！", HudMsgState.确认);
                }
            }
            ...
            if (m_Image)
            {
                if (Target_Image == null)
                {
                    ...
                    if (DebugMode)
                        util_Tools.Func_PrintInfo("XTween控制器消息", $"已找到组件：{m_Image}  ！", HudMsgState.确认);
                }
            }
            ...
            if (m_CanvasGroup)
            {
                if (Target_CanvasGroup == null)
                {
                    ...
                    if (DebugMode)
                        util_Tools.Func_PrintInfo("XTween控制器消息", $"已找到组件：{m_CanvasGroup}  ！", HudMsgState.确认);
                }
            }
            Text m_Hud_Text = GetComponent<Text>();
            if (m_Hud_Text)
            {
                if (Target_HudText == null)
                {
                    Target_HudText = m_Hud_Text;
                    if (DebugMode)
                        util_Tools.Func_PrintInfo("XTween控制器消息", $"已找到组件：{m_Hud_Text}  ！", HudMsgState.确认);
                }
            }
            TextMeshProUGUI m_Hud_TmpText = GetComponent<TextMeshProUGUI>();
            if (m_Hud_TmpText)
            {
                if (Target_HudTmpText == null)
                {
                    Target_HudTmpText = m_Hud_TmpText;
                    if (DebugMode)
                        util_Tools.Func_PrintInfo("XTween控制器消息", $"已找到组件：{m_Hud_TmpText}  ！", HudMsgState.确认);
                }
            }
        }
        #endregion
        ...
        public void Tween_Create()
        {
            ...
            {
                if (DebugMode)
                    util_Tools.Func_PrintInfo("XTween控制器消息", "当动画目标处于： " + TweenTypes.ToString() + " 时，则不会有任何效果！", HudMsgState.警告);
                return;
            }
            ...
            TweenPlay_Fill();
            TweenPlay_Tiled();
            TweenPlay_XHudManager();
            TweenPlay_XHudAnimator();
            TweenPlay_XHudElement();
            TweenPlay_XHudText();
            TweenPlay_XHudTmpText();
            ...
            if (DebugMode)
                util_Tools.Func_PrintInfo("XTween控制器消息", "播放动画： " + TweenTypes.ToString(), HudMsgState.通知, gameObject);
        }
        /// <summary>
        /// 动画播放
        /// </summary>
        public void Tween_Play()
        {
            ...
            {
                if (DebugMode)
                    util_Tools.Func_PrintInfo("XTween控制器消息", "未能播放动画！因为当前不存在动画！", HudMsgState.警告);
                return;
            }
            if (TweenTypes == XTweenTypes.无_None)
            {
                if (DebugMode)
                    util_Tools.Func_PrintInfo("XTween控制器消息", "未能播放动画！因为当前模式不是有效的动画模式！", HudMsgState.警告);
                return;
            }
        ...
        public void Tween_Rewind()
        {
            ...
            {
                if (DebugMode)
                    util_Tools.Func_PrintInfo("XTween控制器消息", "未能倒退动画！因为当前不存在动画！", HudMsgState.警告);
                return;
            }
            CurrentTweener.Rewind();
            if (DebugMode)
                util_Tools.Func_PrintInfo("XTween控制器消息", "倒退动画： " + TweenTypes.ToString(), HudMsgState.警告);
        }
        /// <summary>
        /// 动画杀死
        /// </summary>
        public void Tween_Kill()
        {
            ...
            {
                if (DebugMode)
                    util_Tools.Func_PrintInfo("XTween控制器消息", "未能杀死动画！因为当前不存在动画！", HudMsgState.警告);
                return;
            }
            CurrentTweener.Kill();
            CurrentTweener = null;
            if (DebugMode)
                util_Tools.Func_PrintInfo("XTween控制器消息", "杀死动画： " + TweenTypes.ToString(), HudMsgState.确认);
        }
        /// <summary>
        /// 动画杀死后的委托
        /// </summary>
        ...
        public void Tween_Replay()
        {
            ...
            {
                if (DebugMode)
                    util_Tools.Func_PrintInfo("XTween控制器消息", "未能重播动画！因为当前不存在动画！", HudMsgState.警告);
                return;
            }
            Tween_Rewind();
            Tween_Play();
            if (DebugMode)
                util_Tools.Func_PrintInfo("XTween控制器消息", "重播动画： " + TweenTypes.ToString(), HudMsgState.通知);
        }
        #endregion
    }
}