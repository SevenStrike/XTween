...
#pragma warning restore CS0414
        ...
        public void PathMarks_Create()
        {
            ...
            #region 加载材质和贴图
#if UNITY_EDITOR
            string path_mat = XTween_Dashboard.Get_GUIStyle_Path() + "Icon/Icons_Hud_XTween_PathTool/XTween_PathMark.mat";
            Material mat = AssetDatabase.LoadAssetAtPath<Material>(path_mat);
            if (PathMarksTexture != null)
                mat.mainTexture = PathMarksTexture;
            else
            {
                string path_tex = XTween_Dashboard.Get_GUIStyle_Path() + "Icon/Icons_Hud_XTween_PathTool/PathMark.png";
