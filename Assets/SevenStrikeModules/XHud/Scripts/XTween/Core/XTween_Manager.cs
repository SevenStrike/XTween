    ...
    public class XTween_Manager : MonoBehaviour
    {
        ...
        public static XTween_Manager Instance
        {
            get
            {
                if (_instance == null)
                {
                    util_Tools.Func_PrintInfo("XTween Manager动画管理器消息", "XTween Manager 还没有被实例化！", HudMsgState.确认);
                }
                return _instance;
            }
        }
        ...
        private void InstanceModeCheck()
        {
            ...
            if (XTween_Pool.EnablePool)
            {
                ...
                util_Tools.Func_PrintInfo("XTween Pool动画池消息", "XTween Pool动画池已预加载并就绪！", HudMsgState.确认);
            }
            //DontDestroyOnLoad(gameObject);
            util_Tools.Func_PrintInfo("XTween Manager动画管理器消息", "XTween Manager动画管理器已就绪！", HudMsgState.确认);
        }
        #endregion
